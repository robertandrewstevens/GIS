...
meaning that a regular discretization is sought with approximately 500 points. These default arguments to spsample can be modified by altering the sps.args argument to predict.gstat; spsample is described on p. 118.
